...
const Header: React.FC<HeaderProps> = ({ cartItemsCount, onCartClick, onMenuClick }) => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white border-b-2 border-primos-red shadow-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-2">
            <button 
              onClick={onCartClick}
              className="relative p-3 text-primos-black hover:bg-primos-gray-100 rounded-full transition-all duration-200"
            >
